package com.ugleh.autocraftchest.nms.v1_14_R1;
...
public class NMS implements CraftingUtil {
    ...
    @Override
    public org.bukkit.inventory.ItemStack getResult(org.bukkit.inventory.ItemStack[] contents) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
    ...
    private org.bukkit.inventory.ItemStack tryCraft(Object inventoryCrafting) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
